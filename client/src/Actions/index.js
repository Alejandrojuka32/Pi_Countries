...
export const getAllCountries = () => {
    return function(dispatch){
        return axios.get(URL + "/app/countries")
        .then(info => info.data)
...
export const countryDetail = (payload) =>{
    return function(dispatch){
        return axios.get(`${URL}/app/countries/${payload}`)
        .then(d => d.data)
...
export const searchBar = (name) =>{
    return function(dispatch){
        return axios.get(`${URL}/app/countries/?name=${name}`)
        .then(p => p.data)
...
export const CreateActivities = (payload) =>{
    return function(dispatch){
        return  axios.post(`${URL}/app/activities`,payload)
...
export const allActivities = () =>{
    return function(dispatch){
        return axios.get(URL + "/app/getActivities")
        .then(info => info.data)
...
export const countriesActivities = () =>{
    return function(dispatch){
        return axios.get(URL+ "/app/getCountriesAct")
        .then(info => info.data)
